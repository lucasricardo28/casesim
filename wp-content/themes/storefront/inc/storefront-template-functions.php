		...
		<button class="menu-toggle" aria-controls="site-navigation" aria-expanded="false"><span><?php echo esc_attr( apply_filters( 'storefront_menu_toggle_text', __( 'Menu', 'storefront' ) ) ); ?></span></button>
			...
			wp_nav_menu(
				array(
					...
					'fallback_cb'		=> '',
					'container_class'   => 'text-center nav-primary-menu'
				)
			);
			?>
		</nav><!-- #site-navigation -->
	...
	function storefront_product_categories( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product-category' ) ) {
				...
				echo '<div class="col-full"><section class="storefront-product-section storefront-product-categories" aria-label="' . esc_attr__( 'Product Categories', 'storefront' ) . '">';
	...
	function storefront_recent_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<div class="col-full"><section class="storefront-product-section storefront-recent-products" aria-label="' . esc_attr__( 'Recent Products', 'storefront' ) . '">';
	...
	function storefront_featured_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<div class="col-full"><section class="storefront-product-section storefront-featured-products" aria-label="' . esc_attr__( 'Featured Products', 'storefront' ) . '">';
	...
	function storefront_popular_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<div class="col-full"><section class="storefront-product-section storefront-popular-products" aria-label="' . esc_attr__( 'Popular Products', 'storefront' ) . '">';
	...
	function storefront_on_sale_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<div class="col-full"><section class="storefront-product-section storefront-on-sale-products" aria-label="' . esc_attr__( 'On Sale Products', 'storefront' ) . '">';
	...
	function storefront_best_selling_products( $args ) {
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<div class="col-full"> <section class="storefront-product-section storefront-best-selling-products" aria-label="' . esc_attr__( 'Best Selling Products', 'storefront' ) . '">';
