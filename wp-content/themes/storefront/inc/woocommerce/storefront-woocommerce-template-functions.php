...
if ( ! function_exists( 'storefront_user_account_link' ) ) {
	/**
	 * The account callback function for the handheld footer bar
	 *
	 * @since 2.0.0
	 */
	function storefront_user_account_link() { ?>
		<a href="minha-conta"><i class="fas fa-user fa-2x"></i></a>
	<?php }
}
...
if ( ! function_exists( 'storefront_product_search' ) ) {
		...
		if ( storefront_is_woocommerce_activated() ) { ?>
			<div class="header-second-nav">
				...
				<div class="header-nav-user">
					<?php storefront_user_account_link(); ?>
				</div>
			</div>
	...
	function newCartWithItem(){
		?>
		<a class="header-count-cart" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'storefront' ); ?>">
...
if ( ! function_exists( 'storefront_header_cart' ) ) {
	...
	function storefront_header_cart() {
		//ESTA FUNCAO FOI DESATIVADA USE
		// storefront_header_cart_verify
...
if ( ! function_exists( 'storefront_header_cart_primary' ) ) {
	/**
	 * Display Header Cart
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	function storefront_header_cart_primary() {
		if ( storefront_is_woocommerce_activated() ) {
			if ( is_cart() ) {
				$class = 'current-menu-item';
			} else {
